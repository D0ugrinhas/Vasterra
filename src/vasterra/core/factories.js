...
export const novaSkill = () => ({
  ...
  custos: [],
  custoCatalogo: [
    { id: uid(), nome: "ACO", cor: "#22ee5f", textoCor: "#ffffff" },
    { id: uid(), nome: "MOV", cor: "#227de6", textoCor: "#ffffff" },
    { id: uid(), nome: "REA", cor: "#d31515", textoCor: "#ffffff" },
    { id: uid(), nome: "ESF", cor: "#290404", textoCor: "#ffffff" },
    { id: uid(), nome: "VIT", cor: "#f1250e", textoCor: "#ffffff" },
    { id: uid(), nome: "EST", cor: "#f9f100", textoCor: "#111111" },
    { id: uid(), nome: "MAN", cor: "#0077ff", textoCor: "#ffffff" },
    { id: uid(), nome: "SAN", cor: "#ff4dc4", textoCor: "#ffffff" },
    { id: uid(), nome: "CONS", cor: "#1abc9c", textoCor: "#ffffff" },
  ],
  rolagemTipo: "Padrão",
  rolagemPericia: "",
  rolagemAcao: "Ataque",
